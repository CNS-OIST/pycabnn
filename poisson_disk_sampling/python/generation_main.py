...
from me_geneartion import Bridson_sampling_me
...
#Number of cells
n_mf = (Transverse_range + (2 * Xinstantiate)) * (Horizontal_range + (2 * Yinstantiate)) * MFdensity * 1e-6
...
mf_points = np.hstack((mf_points, np.random.uniform(50, 150, len(mf_points)))) # Randomly make z coordinates
