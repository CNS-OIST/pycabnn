#Comparison: serial and non-serial.
...
import time
t1= time.time()
print ('Starting Comparison process for full cell population')
...
print ('Sequential finished after', t6 - t4)
...
print ('Serial finished after', st4 - st0)
